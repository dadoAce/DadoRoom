...
<html>
    <head>
        <?php include_once 'Views/complementos/referencias.php'; ?>
    ...
    <body>
        ...
        <div class="container ">
            ...
            <section class="d-flex flex-row justify-content-start align-items-center text-white pt-5 pb-5">
                <h3> <i class="red bi bi-calendar4 pr-2"></i></h3> <h1 style="font-family: system-ui;"> Shedule</h1>
            </section>
        </div>
                ...
                <div class="  col-12 col-sm-6 offset-sm-1   bg-light rounded w-75">
                    ...
                    <div class="row">
                        <div class=" col-12 d-flex flex-row justify-content-between align-items-center  ">
                            ...
                            <button class="btn " data-target="#modal-add-evento-usuario" data-toggle="modal"><h3><i class="bi bi-upload "></i></h3></button>
                        </div>
                        <div class=" col-12 ">
...
<?php include_once 'Views/complementos/referencias_footer.php'; ?> 
<?php include_once 'Views/complementos/referencias_footer_callendar.php'; ?> 
